...
import jp.ac.meijou.android.s251205184.databinding.ActivityMain6Binding;
...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonIP.setOnClickListener(v -> {
            updateNetwork();
        });
        ...
        binding.textIpAdress.setTextColor(Color.parseColor("#299292"));
